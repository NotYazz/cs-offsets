    ...
    pub mod schemas {
        ...
        pub mod client_dll {
            ...
            pub mod C_CSGameRules {
                ...
                pub const m_iRoundEndFunFactPlayerSlot: usize = 0xEE8; // 
            ...
            pub mod CCSPlayerController {
                ...
                pub const m_nQuestProgressReason: usize = 0x7BC; // 
                ...
                pub const m_hOriginalControllerOfCurrentPawn: usize = 0x848; // 
